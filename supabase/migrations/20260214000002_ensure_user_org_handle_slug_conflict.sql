  -- Handle duplicate organization slug when a different account has the same name
  -- (e.g. two users both "George Goloborodkin" -> slug "george-goloborodkin" already exists)
